...
for (marker in markers) {
  ...
  # Call summ_data_function to summarize data and store results in the summarized_data list we initiated earlier
...
for (marker in markers) {
  # Call stats_test function and then store results in stats_results list initiated earlier
